import fitz
import os
from app.config import CHUNK_SIZE, CHUNK_OVERLAP, CHROMA_PATH
...
def get_collection():
    """Always fetches a fresh collection reference from ChromaDB."""
...
def store_chunks(chunk_records):
    """Encodes chunks using sentence-transformers and stores documents, embeddings, and metadata in ChromaDB."""
...
def ingest_document(pdf_path: str):
    ...
    try:
        ...
        chunk_records = prepare_chunks(pdf_path)
